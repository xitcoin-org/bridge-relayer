...
export async function readDestinationResponse(readResponse, { timeoutMs = 5000, maxBytes = 32768 } = {}) {
  if (typeof readResponse !== "function" || !Number.isSafeInteger(timeoutMs) || timeoutMs < 1 || timeoutMs > 10000
      || !Number.isSafeInteger(maxBytes) || maxBytes < 1 || maxBytes > 32768) throw new Error("invalid destination response");
